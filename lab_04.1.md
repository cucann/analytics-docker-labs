...
<img width="1460" height="756" alt="image" src="https://github.com/user-attachments/assets/ef4eea0b-30a7-4eff-8124-25a4b8149946" />


## Вывод

В результате выполнения лабораторной работы было разработано и развернуто в Kubernetes **полнофункциональное приложение для управления корпоративными событиями (Event Manager)**. 

**Реализованный функционал:**

- **Бэкенд:** REST API на FastAPI с подключением к MongoDB, поддерживающее CRUD операции (создание, чтение, обновление, удаление событий)
- **Фронтенд:** Интерактивный интерфейс на Streamlit с пятью разделами (все события, добавление, аналитика, календарь, настройки)
- **База данных:** MongoDB для хранения информации о событиях (название, дата, время, место, участники)

**Дополнительные улучшения:**

- Уведомления о предстоящих событиях
- Таймер обратного отсчёта до ближайшего события
- Рейтинг самых активных участников
- Расширенная аналитика с графиками Plotly
- Календарный вид для планирования
- Экспорт данных в CSV и Excel
- Полноценное редактирование событий

**Технические результаты:**

-  Успешная контейнеризация обоих сервисов с помощью Docker
-  Корректная работа всех компонентов в Kubernetes
-  Настроенное сетевое взаимодействие между микросервисами
-  Безопасное хранение учетных данных через Secrets
-  Сохранение данных при перезапуске подов

Приложение полностью соответствует требованиям и успешно решает бизнес-задачу по управлению корпоративными событиями, предоставляя пользователям удобный инструмент для планирования и анализа.
